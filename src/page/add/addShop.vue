...
<script>
import { getlocation, addShop, searchAddres, foodCategory } from '@/api/api.js'
...
export default {
  ...
  methods: {
    ...
    async querySearchAsync (queryString, cb) {
      if (queryString) {
        try {
          const cityList = await searchAddres(this.city.id, queryString)
